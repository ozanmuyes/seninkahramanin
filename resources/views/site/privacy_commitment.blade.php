...
@section("title", "Gizlilik Taahhüdü ve Gizlilik Politikası")
    ...
    <div class="row">
        <article class="col-md-6 col-md-offset-3">
            ...
            <ol>
                ...
                <li>Elektronik posta adresiniz hiçbir şekilde başka kurum, kuruluş ya da şahıslara dağıtılmaz. Müşteri bilgileriniz sadece şirketimiz dahilinde müşteri profili olşturmak ve/veya e-posta basın bülteni, kampanya duyurusu göndermek için izniniz dahilinde kullanılır, üçüncü şahıslara verilmez.</li>
                ...
                <li><b>seninkahramanin.com</b> müşterilerimizin Kredi Kartı bilgilerini kesinlikle saklamaz. Kredi Kart bilgileriniz sadece tahsilat işlemi sırasında ilgili bankalara güvenli bir şekilde iletilerek provizyon alınması amacı ile bir kereye mahsus kullanılır ve provizyon işlemi sonrasında sistemimizden otomatik olarak silinir.</li>
                ...
                <li><b>seninkahramanin.com</b> sitemizi kullanmaya başladığınız andan itibaren sözleşmede yazılı tüm hususları tamamen anlamış ve kabul etmiş sayılırsınız. <b>seninkahramanin.com</b> bu maddelerde önceden haber vermeksizin değişiklik yapma hakkına sahiptir. Bu şartlardan bir ya da bir kaçının ihlal edilmesi durumunda herhangi bir ihtar, uyarı veya bilgi vermeksizin kullanımınızı kısıtlama ya da son verme hakkı <b>seninkahramanin.com</b>'a saklıdır. <b>seninkahramanin.com</b>'u kullanırken tüm işlemlerinizden kişisel olarak sadece kendizin sorumlu olduğunuzu ve eylemlerinizin nedeniyle zarar görebilecek herkesin zararlarını tazmin etmek zorunda kalacağınız hususunu önemle bildiririz.</li>

                <li>Üyelik Şartlarını kabul etmiş kullanıcılar, yukarıdaki şartları kabul etmiş sayılır.</li>
            </ol>
        </article>
    </div>
@endsection
